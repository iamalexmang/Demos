...
# test it out
http://ghostrubrikk.westeurope.azurecontainer.io:2368
http://ghostrubrikk.westeurope.azurecontainer.io:2368/admin
...
$resourceGroup = "rubrikk_demoaciacr_rg"
$location = "westeurope"
az group create -n $resourceGroup -l $location

# ACR we'll be using
$acrName = "rubrikkregistry"
...
$image = "catweb:latest" # can add a tag here
...
$containerGroupName = "aci-acr-catweb"
...
$downloadPath = "C:\Users\amang\Downloads\message.txt"
